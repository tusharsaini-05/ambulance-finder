...
//   const activeBooking = currentBooking || bookings.find(booking => 
...
//             <div>
//               <h3 className="text-lg font-semibold text-emergency-900">
//                 Emergency Hotline
//               </h3>
...
//             <Link
//               to="/history"
//               className="text-emergency-600 hover:text-emergency-700 font-medium text-sm"
//             >
//               View all
//             </Link>
//           </div>
...
//                       window.location.href = `/track/${booking.id}`
//                     }
//                   }}
//                   actionLabel={
//                     ['pending', 'accepted', 'en_route', 'arrived'].includes(booking.status)
...
//                 Book your first ambulance to get started
//               </p>
//               <Link
//                 to="/book"
//                 className="btn btn-emergency btn-md inline-flex items-center space-x-2"
//               >
...
import { useAuth } from "../../contexts/AuthContext"
import { useBooking } from "../../contexts/BookingContext"
import { Plane as Ambulance, Clock, Plus, History, AlertTriangle, CheckCircle } from "lucide-react"
import LoadingSpinner from "../../components/LoadingSpinner"
import BookingCard from "../../components/BookingCard"
